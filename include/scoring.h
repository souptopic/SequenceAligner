...
#define MIN_SCORE         (-5) // Minimum BLOSUM50 score
...
#define get_score(matrix, a, b) ((matrix)[AMINO_LOOKUP[(int)(a)]][AMINO_LOOKUP[(int)(b)]])

INLINE void init_scoring_matrix(ScoringMatrix* matrix) {
    ...
    FIRST_ROW_INDICES = _mm256_setr_epi32(1, 2, 3, 4, 5, 6, 7, 8);
    GAP_PENALTY_VEC = _mm256_set1_epi32(GAP_PENALTY);
