...
type_orig,type_comp,name1,name2,seq_first,seq_second,aligned_sequence,points""",
    ...
    "INPUT_FILE": "Path to input file for singlethreaded mode (good for small datasets)",
    "INPUT_MT_FILE": "Path to input file for multithreaded mode (good for large datasets)", 
    "OUTPUT_FILE": "Path to output file for singlethreaded mode",
    "OUTPUT_MT_FILE": "Path to output file for multithreaded mode",
...
DISPLAY_NAMES = {
    ...
    "INPUT_FILE": "Input File (Singlethreaded)",
    "INPUT_MT_FILE": "Input File (Multithreaded)",
    "OUTPUT_FILE": "Output File (Singlethreaded)", 
    "OUTPUT_MT_FILE": "Output File (Multithreaded)",
